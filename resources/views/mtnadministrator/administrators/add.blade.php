                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <form id="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="admin_phone_number" name="admin_phone_number" class="form-control" placeholder="Enter Phone Number">
                                </div>
                                <div class="form-group">
                                    <label for="admin_email">Email Address</label>
                                    <input type="text" id="admin_email" name="admin_email" class="form-control" placeholder="Enter Email Address">
                                </div>
                                <div class="row">
